<div class="flex flex-col h-full">
    <div class="flex flex-col h-full">
        <x-edit-committee-navbar :committeeToken="$token" :committeeName="$name" />

        <div class="flex-1 overflow-y-auto">
            <div class="p-6 sm:p-8 space-y-6">
                <flux:fieldset>
                    <legend>{{ __('messages.general') }}</legend>
                ...
                <flux:fieldset>
                    <legend>{{ __('messages.meetingDate') }}</legend>
                    <div class="p-4 space-y-4">
                        <div class="grid sm:grid-cols-2 gap-4">
                            <flux:field>
                ...
                <flux:fieldset>
                    <legend>{{ __('messages.meetingPlace') }}</legend>
                    <div class="p-4 space-y-4">
                        ...
                        <flux:field>
                            ...
                            <div wire:ignore id="map" class="z-10 h-[16rem] lg:h-[20rem]"></div>
            ...
            <div class="py-6 mt-auto mt-auto px-8 flex items-center justify-end gap-x-4 border-t border-zinc-200 dark:border-zinc-900 bg-zinc-100 dark:bg-zinc-800">
