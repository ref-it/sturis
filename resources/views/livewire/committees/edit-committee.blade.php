<div class="p-6 sm:px-8 space-y-8">
    <div class="space-y-4">
        <flux:heading size="xl">{{ __('messages.editCommittee') }}</flux:heading>
    </div>
            ...
            <flux:fieldset>
                ...
                <div class="p-4 space-y-4">
                    <flux:field>
                        ...
                        <flux:input wire:model="token" disabled />
            ...
            <flux:fieldset>
                ...
                <div class="p-4 space-y-4">
                    <flux:field>
                        ...
                        <flux:input
                            wire:model="wikiPathInternal"
                            :disabled="!$minutesInWiki"
                        />
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        <flux:field>
                            ...
                            <div class="block">
                                <flux:switch
                                    wire:model="minutesSeparatedByTerm"
                                    :disabled="!$minutesInWiki"
                                />
                            </div>
                        </flux:field>
                        <flux:field>
                            ...
                            <div class="block">
                                <flux:switch
                                    wire:model="minutesSeparatedByYear"
                                    :disabled="!$minutesInWiki"
                                />
                            </div>
                        </flux:field>
